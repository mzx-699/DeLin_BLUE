    ...
    if (_recivedData68)
    {
        if(self.updateFlag == 1) {
            ...
            switch (self.sendUpdateFrameType) {
                ...
                case sendEndFrame:
                    NSLog(@"更新结束帧");
                    [[NSNotificationCenter defaultCenter] postNotificationName:@"sendUpdateEndFrame" object:nil userInfo:nil];
                    break;
            ...
            switch (self.frame68Type) {
                case readReplyFrame:
                {
                    ...
                    if (self.msg68Type == getMainDeviceMsg) {
                        ...
                        NSNumber *monToWedState = _recivedData68[14];
                        ...
                        [dataDic setObject:monToWedState forKey:@"monToWedState"];
                        ...
                        NSNumber *thuToSunState = _recivedData68[16];
                        ...
                        [dataDic setObject:thuToSunState forKey:@"thuToSunState"];
